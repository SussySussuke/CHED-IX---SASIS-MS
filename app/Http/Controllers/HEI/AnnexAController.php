...
class AnnexAController extends BaseAnnexController
{
    public function create()
    {
        $heiId = $this->getHeiId();

        return inertia('HEI/Forms/AnnexACreate', [
            'availableYears' => $this->getAvailableYears(),
            'existingBatches' => $this->getExistingBatches(AnnexABatch::class, $heiId, ['programs']),
    ...
    public function store(Request $request)
    {
        ...
        $existingBatch = $this->getExistingRecord(AnnexABatch::class, $academicYear, $heiId);
        [$newStatus, $message] = $this->determineStatusAndMessage($existingBatch, 'Annex A');

        if ($existingBatch) {
            $this->overwriteExisting(AnnexABatch::class, $heiId, $academicYear, $existingBatch->status);
        }
    ...
    {
        $batches = AnnexABatch::where('hei_id', $this->getHeiId())
            ->withCount('programs')
