 ...
 *   Row 5..12: Col 1: service_type (locked) | Col 2: with (YES/NO) | Col 3: supporting_docs | Col 4: remarks
 *
 * Table 2 (Admission Statistics) starts at row 14:
 *   Col 1: program | Col 2: applicants | Col 3: admitted | Col 4: enrolled
 */
class AnnexHParser extends BaseParser
{
    private const SERVICES_ROW_START = 5;
    private const STATS_ROW_START    = 14;
