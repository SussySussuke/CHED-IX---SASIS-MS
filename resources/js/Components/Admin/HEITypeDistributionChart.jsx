...
const HEITypeDistributionChart = ({ data }) => {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 h-full">
        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <p className="text-gray-500 dark:text-gray-400 text-sm">No HEI data available</p>
            <p className="text-gray-400 dark:text-gray-500 text-xs mt-1">Add HEI accounts to see distribution</p>
          </div>
        </div>
      </div>
    );
  ...
  const chartData = [
    ...
    },
    {
      ...
      gradientId: 'gradient-hei-luc',
      colorLight: 'rgba(255, 230, 0, 0.9)',   // yellow-400
      colorDark: 'rgba(248, 147, 5, 0.99)',    // yellow-700   
    ...
    },
    {
      ...
      gradientId: 'gradient-hei-private',
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="text-right">
                      <p className={`text-base font-bold ${item.value === 0 ? 'text-gray-400 dark:text-gray-600' : 'text-gray-900 dark:text-white'}`}>
                        {item.value}
                      </p>
                      <p className={`text-xs ${item.value === 0 ? 'text-gray-400 dark:text-gray-600' : 'text-gray-500 dark:text-gray-400'}`}>
                        {percentage}%
                      </p>
                    </div>
                  </div>
