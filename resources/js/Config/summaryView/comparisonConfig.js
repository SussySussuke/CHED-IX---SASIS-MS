...
export const SECTION_COMPARISON_FIELDS = {
  ...
  '1B-Personnel': {
    fetchable: true,
    fields: [
      { field: 'registered_guidance_counselors', label: 'Registered Guidance Counselors',  type: 'numeric', clickable: true, categoryKey: 'registered_guidance_counselors' },
      { field: 'guidance_counseling',            label: 'Guidance & Counseling',           type: 'numeric', clickable: true, categoryKey: 'guidance_counseling' },
      { field: 'career_guidance_placement',      label: 'Career Guidance / Placement',     type: 'numeric', clickable: true, categoryKey: 'career_guidance_placement' },
      { field: 'registrars',                     label: 'Registrars',                      type: 'numeric', clickable: true, categoryKey: 'registrars' },
      { field: 'admission_personnel',            label: 'Admission Personnel',             type: 'numeric', clickable: true, categoryKey: 'admission_personnel' },
      { field: 'physician',                      label: 'Physician',                       type: 'numeric', clickable: true, categoryKey: 'physician' },
      { field: 'dentist',                        label: 'Dentist',                         type: 'numeric', clickable: true, categoryKey: 'dentist' },
      { field: 'nurse',                          label: 'Nurse',                           type: 'numeric', clickable: true, categoryKey: 'nurse' },
      { field: 'other_medical_health',           label: 'Other Medical / Health Workers',  type: 'numeric', clickable: true, categoryKey: 'other_medical_health' },
      { field: 'security_personnel',             label: 'Security Personnel',              type: 'numeric', clickable: true, categoryKey: 'security_personnel' },
      { field: 'food_service_personnel',         label: 'Food Service Personnel',          type: 'numeric', clickable: true, categoryKey: 'food_service_personnel' },
      { field: 'cultural_affairs',               label: 'Cultural Affairs',                type: 'numeric', clickable: true, categoryKey: 'cultural_affairs' },
      { field: 'sports_development',             label: 'Sports Development',              type: 'numeric', clickable: true, categoryKey: 'sports_development' },
      { field: 'student_discipline',             label: 'Student Discipline',              type: 'numeric', clickable: true, categoryKey: 'student_discipline' },
      { field: 'scholarship_personnel',          label: 'Scholarship Personnel',           type: 'numeric', clickable: true, categoryKey: 'scholarship_personnel' },
      { field: 'housing_residential',            label: 'Housing / Residential / Dorm',    type: 'numeric', clickable: true, categoryKey: 'housing_residential' },
      { field: 'pwd_special_needs',              label: 'PWD / Special Needs',             type: 'numeric', clickable: true, categoryKey: 'pwd_special_needs' },
      { field: 'student_governance',             label: 'Student Governance',              type: 'numeric', clickable: true, categoryKey: 'student_governance' },
      { field: 'student_publication',            label: 'Student Publication',             type: 'numeric', clickable: true, categoryKey: 'student_publication' },
      { field: 'multi_faith',                    label: 'Multi-faith Services',            type: 'numeric', clickable: true, categoryKey: 'multi_faith' },
      { field: 'uncategorized',                  label: 'Uncategorized',                   type: 'numeric', clickable: true, categoryKey: 'uncategorized' },
