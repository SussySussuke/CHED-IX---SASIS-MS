...
export const GUIDANCE_COUNSELLING_CATEGORY_LABELS = {
  individual_inventory: 'Individual Inventory',
  counseling_service:   'Counseling Service',
  referral:             'Referral',
  testing_appraisal:    'Testing / Appraisal',
  follow_up:            'Follow-up',
  peer_facilitating:    'Peer Facilitating Program/Activities',
