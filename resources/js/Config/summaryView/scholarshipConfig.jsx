...
function CountCell({ value, onClick }) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      title="Click to view scholarship details"
    >
      {value} →
    </button>
  );
...
export const scholarshipConfig = {
  ...
  getColumns: (onScholarshipClick = null) => [
    {
    ...
    {
      headerName: 'Total No. of Scholarships and Financial Assistance Administered/Implemented',
      field:      'total_scholarships',
      width:      260,
      ...
      cellRenderer: (params) => (
        <CountCell
          value={params.value}
          onClick={() =>
            onScholarshipClick?.(params.data.hei_id, params.data.hei_name)
          }
        />
      ),
    },
    {
      headerName: 'Total No. of Beneficiaries',
