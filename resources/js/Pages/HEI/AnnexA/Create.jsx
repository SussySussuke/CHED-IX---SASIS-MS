...
const Create = ({ availableYears = [], existingBatches = {}, defaultYear, isEditing = false }) => {
  ...
  return (
    <HEILayout title="Submit Annex A">
      ...
      <div className="space-y-6">
        <div>
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              LIST OF PROGRAMS/ PROJECTS/ ACTIVITIES INFORMATION AND ORIENTATION SERVICES
            </h1>
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700 space-y-6">
          {shouldLock && (
            <SubmissionLock
              ...
              editUrl={existingBatch?.batch_id ? `/hei/annex-a/edit/${existingBatch.batch_id}` : null}
              historyUrl="/hei/annex-a/history"
            />
          )}
        ...
        <div>
          ...
          <div className="flex justify-end gap-4">
            <button
              type="button"
              onClick={() => router.visit('/hei/annex-a/history')}
