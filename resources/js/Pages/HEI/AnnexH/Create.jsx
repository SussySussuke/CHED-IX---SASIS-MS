...
const Create = ({ availableYears = [], existingBatches = {}, defaultYear, isEditing = false }) => {
  ...
  const admissionServices = existingBatch?.admissionServices || [];
  const admissionStatistics = existingBatch?.admissionStatistics || [];
        ...
        <div className="relative space-y-6">
          {shouldLock && (
            <SubmissionLock
              ...
              editUrl={existingBatch?.batch_id ? `/hei/annex-h/edit/${existingBatch.batch_id}` : null}
              historyUrl="/hei/annex-h/history"
            />
          )}
